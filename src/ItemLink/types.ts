...
export const TraitColors = {
    [Trait.STURDY]: '#8eb1b5',
    [Trait.IMPENETRABLE]: '#bbd0f7',
    [Trait.REINFORCED]: '#30272e',
    [Trait.WELL_FITTED]: '#961631',
    [Trait.TRAINING]: '#7f994e',
    [Trait.INFUSED]: '#846464',
    [Trait.INVIGORATING]: '#f8afc8',
    [Trait.DIVINES]: '#294597',
    [Trait.NIRNHONED]: '#cc4627',
    [Trait.HEALTHY]: '#952541',
    [Trait.ARCANE]: '#6b9cd4',
    [Trait.ROBUST]: '#617756',
    [Trait.BLOODTHIRSTY]: '#9a3124',
    [Trait.HARMONY]: '#353634',
    [Trait.TRIUNE]: '#d68245',
    [Trait.SWIFT]: '#dcc190',
    [Trait.PROTECTIVE]: '#d4d0d8',
    [Trait.POWERED]: '#a8bb3f',
    [Trait.CHARGED]: '#8c2793',
    [Trait.PRECISE]: '#5c0504',
    [Trait.SHARPENED]: '#f5e6c5',
    [Trait.DEFENDING]: '#298f9f',
    [Trait.DECISIVE]: '#cb9176',
    [Trait.ORNATE]: '#e5c300',
